...
const SearchByOrigin = () => {
    ...
    return (
      <List className="p-0">
        <ListItem>
          <ListItemPrefix>
            <Checkbox label="antibacterial" onChange={() => handleCheckboxChange('Plant')} />
          </ListItemPrefix>
          <ListItemPrefix>
            <Checkbox label="anticancer" onChange={() => handleCheckboxChange('Fungus')} />
          </ListItemPrefix>
          <ListItemPrefix>
            <Checkbox label="antihelmetic" onChange={() => handleCheckboxChange('Animal')} />
          </ListItemPrefix>
        </ListItem>
